...
const arr = [23, 11, 64];
console.log(arr[0]);
console.log(arr.at(0)); // specify the position of element you want to extract using at() method
...
console.log('Himal'.at(0));
console.log('Himal'.at(-1));
...
//   return acc + cur;
// }, 0); // initial value of accumulator is determined as 0
...
console.log(convertTitleCase('this is LONG nice title'))
